...
import '../network/errorHandler.dart';
...
abstract class LocalDataSource {
  ...
  Future<void> saveExerciseDetailsToCache(ExerciseResponse response);
}
...
class LocalDataSourceImplementer implements LocalDataSource {
  ...
  @override
  Future<ExerciseResponse> getExerciseDetails() async {
  ...
  @override
  Future<void> saveExerciseDetailsToCache(ExerciseResponse response) async {
